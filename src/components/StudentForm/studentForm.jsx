...
const StudentForm =()=>{
    ...
    <form onSubmit={submitHandler}>
        ...
        <input type='text'  name='firstName' value={firstName} required onChange={handleOnChanges}></input>
       </div>
       <div>
        <label>Last Name</label>
        <input type='text' name="lastName" value={lastName} onChange={handleOnChanges}></input>
        </div> <div>
        <label>Age</label>
        <input type='text' name="age" value={age} onChange={handleOnChanges}></input>
        </div>
        <div>
        <label>Major</label>
        <input type='text' name="major" value={major} onChange={handleOnChanges}></input>
        </div>
